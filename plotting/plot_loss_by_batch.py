...
plot_loss_by_batch(loss_path=["./checkpoints/unet_1_datafull_oldsplit",
                              "./checkpoints/unet_2_datared_oldsplit"],
                   epoch_counts=[2, 2],
                   ma_k_size=5000,
                   dataset="val",
                   fig_save=False,
                   fig_path="./figures",
                   fig_name="val loss by batch comp")
...
plot_loss_by_batch(loss_path=["./checkpoints/unet_1_datafull_oldsplit",
                   ...
                   fig_save=False,
                   fig_path="./figures",
                   fig_name="train loss by batch comp")

plot_loss_by_epoch(loss_path=["./checkpoints/unet_1_datafull_oldsplit",
                              "./checkpoints/unet_2_datared_oldsplit"],
                   fig_save=False,
                   fig_path="./figures",
                   fig_name="Train+Val loss per epoch comp")
