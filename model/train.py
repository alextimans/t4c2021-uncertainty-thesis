...
def run_model_ddp(rank: int,
    ...
    torch.distributed: https://pytorch.org/docs/stable/distributed.html#which-backend-to-use
    ...
    tried cuda/11.0.3 => cuda/10.2.89 module load as similarly suggested here:
